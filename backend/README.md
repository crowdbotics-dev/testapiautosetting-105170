...
## Project Structure
    ...
    ├── testapiautosetting_105170  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_105170`
...
2. Clone this repo and `cd testapiautosetting_105170`
